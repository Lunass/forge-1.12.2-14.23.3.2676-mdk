...
public class TileEntityOreWasher extends TileEntity implements ITickable, IInventory {
    ...
    public static List<EntityItem> GetItemsAbove(World worldIn, double xpos, double ypos, double zpos){
        return worldIn.<EntityItem>getEntitiesWithinAABB(EntityItem.class, new AxisAlignedBB(xpos - 0.5D, ypos, zpos - 0.5D, xpos + 0.5D, ypos + 1.5D, zpos + 0.5D),EntitySelectors.IS_ALIVE);
    }
    ...
    private boolean canSmelt() {
        if(((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty())return false;
            ...
            ItemStack result = OreWasherRecipes.getInstance().getOreWasherResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
    ...
    public void smeltItem() {
        if(this.canSmelt()){
            ...
            ItemStack result = OreWasherRecipes.getInstance().getOreWasherResult(input1, input2);
            ItemStack output = (ItemStack)this.inventory.get(3);
    ...
    public static int getItemBurnTime(ItemStack fuel)
    {
        ...
        else
        {
            ...
            if (item == Items.WATER_BUCKET) return 20000;
    ...
    {
        return this.hasCustomName() ? this.customName : "container.ore_washer";
    }
    @Override
